...
final class MockBookService: Sendable {
    ...
    func generateBooks(count: Int) async -> [BookPersistent.SendableType] {
        let books = self.books
        var result: [BookPersistent.SendableType] = []
...
extension MockBookService {
    ...
    var book: BookPersistent.SendableType {
        BookPersistent(bookId: 1,
 ...
 """, rating: 5).sendable
    ...
    var books: [BookPersistent.SendableType] {
        [
            BookPersistent(bookId: 1,
                           name: "The Fountainhead",
                           imageName: "book_cover_fountainhead",
     ...
     The Fountainhead is a 1943 novel by Russian-American author Ayn Rand, her first major literary success. The novel's protagonist, Howard Roark, is an intransigent young architect, who battles against conventional standards and refuses to compromise with an architectural establishment unwilling to accept innovation. Roark embodies what Rand believed to be the ideal man, and his struggle reflects Rand's belief that individualism is superior to collectivism.
     """, rating: 5).sendable,
            BookPersistent(bookId: 2, name: "The Godfather", imageName: "book_cover_godfather", author: "Mario Puzo", bookDescription: """
    ...
    """, rating: 5).sendable,
            BookPersistent(bookId: 3, name: "Red Dragon", imageName: "book_cover_red_dragon", author: "Thomas Harris", bookDescription: """
        ...
        """,
                           rating: 5).sendable,
            BookPersistent(bookId: 4, name: "Hannibal", imageName: "book_cover_hannibal", author: "Thomas Harris", bookDescription: """
    ...
    """, rating: 4).sendable,
            BookPersistent(bookId: 5, name: "Hannibal Rising", imageName: "book_cover_hannibal_rising", author: "Thomas Harris", bookDescription: """
